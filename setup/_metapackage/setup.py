...
setuptools.setup(
    ...
    install_requires=[
        ...
        'odoo-addon-mrp_bom_produce_delay>=16.0dev,<16.1dev',
        ...
        'odoo-addon-mrp_bom_widget_section_and_note_one2many>=16.0dev,<16.1dev',
        ...
        'odoo-addon-mrp_unbuild_subcontracting>=16.0dev,<16.1dev',
